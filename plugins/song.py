...
async def start(client, message):
       await message.reply("𝐼'𝓂 𝒽𝑒𝓁𝓅𝒾𝓃𝑔 𝓎𝑜𝓊 𝓉𝑜 𝓅𝓁𝒶𝓎 𝓎𝑜𝓊𝓇 𝓁𝑜𝓋𝑒𝒹 𝒶𝓃𝒹 𝒻𝒶𝓋𝑜𝓊𝓇𝒾𝓉𝑒 𝓈𝑜𝓃𝑔𝓈 𝒾𝓃 𝒶𝓃𝓎 𝓅𝓁𝒶𝒸𝑒 𝓎𝑜𝓊 𝓃𝑒𝑒𝒹.[🎶](https://telegra.ph/file/507fa8e980c6274aa1a59.jpg)𝒟𝑜 𝓎𝑜𝓊 𝓌𝒶𝓃𝓉 𝓉𝑜 𝓀𝓃𝑜𝓌 𝓂𝑜𝓇𝑒 𝒶𝒷𝑜𝓊𝓉 𝓂𝑒 𝒽𝒾𝓉 𝓉𝒽𝑒 @𝒮𝐿𝒯𝑒𝓁𝑒𝐵𝑜𝓉𝓈.",
...
async def help(client, message):
       await message.reply("<b>𝐻𝒾𝓉 𝒽𝑒𝓁𝓅 𝒷𝓊𝓉𝓉𝑜𝓃 𝓉𝑜 𝒻𝒾𝓃𝒹 𝑜𝓊𝓉 𝓂𝑜𝓇𝑒 𝒶𝒷𝑜𝓊𝓉 𝒽𝑜𝓌 𝓉𝑜 𝓊𝓈𝑒 𝓂𝑒... 𝒮𝑒𝓃𝒹 - /𝒽𝑒𝓁𝓅 </i>\n\n<b>Eg</b> `Vaathi Coming`",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Developer', url='https://t.me/RolexXTm2')
                ]
            ]
        )
    )
